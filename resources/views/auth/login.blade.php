...
@section('content')
    <form method="POST" action="{{ route('login') }}" class="lg:w-1/2 lg:mx-auto bg-card py-12 px-16 rounded shadow">
        ...
        <h1 class="text-2xl font-normal mb-10 text-center font-bold">Login</h1>
        ...
        <div class="field mb-6">
            <div class="col-md-8 offset-md-4">
                ...
                @if (Route::has('password.request'))
                    <a class="text-default text-sm no-underline hover:underline" href="{{ route('password.request') }}">
